---
title: "iVizLab - AI Ethics: Climate"
layout: textlay.njk
excerpt: "iVizLab -- AI Ethics: Climate"
permalink: /aiEthicsC/
researchTag: aiEthics
---

# AI Ethics: Climate

<strong>[See Related Papers](#paperSection) and Related Projects:</strong><br>
[AI Ethics: Gender](/aiEthicsG) &nbsp; [AI Anonymization](/aiAnon)

Researchers: Vanessa Utz, Steve DiPaola

**The Research:**

We should note that besides this area, our AI Ethics work is also wide ranging in privacy, gender, security, health, activism, ownership, futures, and outreach.
